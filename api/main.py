...
if not SECRET_KEY:
    raise RuntimeError("SECRET_KEY environment variable is not set. Add it as a Secret in your Hugging Face Space settings (any long random string works).")
ALGORITHM = "HS256"
...
if not GEMINI_API_KEY:
    raise RuntimeError("GEMINI_API_KEY environment variable is not set. Add it as a Secret in your Hugging Face Space settings.")
